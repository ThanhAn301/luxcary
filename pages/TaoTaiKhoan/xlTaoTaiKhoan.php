...
if (isset($_POST["us"])) {
    ...
    $birth = $_POST["lsbYear"] . '-' . substr($_POST["lsbMonth"], 7) . '-' . $_POST["lsbDate"];
    $add = $_POST["txtDiaChi"];
    ...
    if ($row != null) {
        ...
        $sql = 'INSERT INTO TaiKhoan (TenDangNhap, MatKhau, TenHienThi, DiaChi, NgaySinh, MaLoaiTaiKhoan) VALUES ("' . $us . '","' . $ps . '","' . $name . '","' . $add . '","' . $birth . '", 1)';
