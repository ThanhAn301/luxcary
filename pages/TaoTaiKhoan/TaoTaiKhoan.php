    ...
    <form action="pages/TaoTaiKhoan/xlTaoTaiKhoan.php"  onsubmit="return KiemTra()" method="POST">
        ...
        <div class="row">
            <div class="col">
                ...
                <input type="text" id="txtFname" name="txtFname" class="form-control" placeholder="Last name" >
                <div class="err" id="eFNAME"></div>
            </div>
            <div class="col">
                <label>Tên</label>
                <input type="text" id="txtLname" name="txtLname" class="form-control" placeholder="First name" >
